...
function german_glitche_force_dark_css() {
    ...
    <style>
        ...
        .section .content .title .title_inner { box-shadow: inset 0 -6px 0px #FDBD06 !important; }
        ...
        .section.started .mouse_btn, .section.started .mouse_btn .ion { color: #FDBD06 !important; }

        /* Iconos de servicios */
        .service-items .service-item .icon, .service-items .service-item .service-item-inner:hover .icon { color: #FDBD06 !important; }

        /* Skills alternativos */
        .skills.list ul li .name:before, .skills.dotted ul li .progress .da span, .skills.circles .progress .bar { color: #FDBD06 !important; background-color: #FDBD06 !important; border-color: #FDBD06 !important; }

        /* Hover nombre de proyectos */
        .box-items .box-item:hover .desc .name { color: #FDBD06 !important; }
    </style>
    <?php
}
